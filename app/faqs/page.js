...
const page = () => {
      ...
      sections: [
          ...
          questions: [
            {
              ...
              answer:
                "A trademark is a distinctive sign, symbol, word, or phrase that identifies and distinguishes the source of goods or services of one business from those of others. In Nigeria, trademarks can include names, logos, slogans, colors, sounds, or any combination that serves to identify your brand in the marketplace.",
            },
            {
            ...
            },
            {
              ...
              answer:
                "In Nigeria, trademark registration is valid for 7 years from the date of filing. After the initial period, it can be renewed for subsequent periods of 14 years each, indefinitely, as long as renewal fees are paid and the trademark continues to be used in commerce.",
            },
          ],
        },
        {
          ...
          questions: [
            {
              ...
              answer:
                "Yes, conducting a trademark search before filing is highly recommended. This helps identify potential conflicts with existing trademarks and increases your chances of successful registration. A thorough search can save time and money by avoiding objections during the examination process.",
            },
            {
          ...
          questions: [
            {
              ...
              answer:
                "Any individual, company, partnership, or organization that uses or intends to use a trademark in Nigeria can file an application. Foreign applicants must have an address for service in Nigeria or appoint a local agent/attorney to represent them.",
            },
            {
            ...
            },
            {
              ...
              answer:
                "You cannot register marks that are: descriptive of goods/services, generic terms, deceptive or misleading, contrary to public policy or morality, similar to existing registered marks, national emblems or flags, or lacking distinctiveness. Geographical names and surnames may also face restrictions.",
            },
            {
              question: "Is there any disclaimer practice?",
              answer:
                "Yes, disclaimers may be required for descriptive elements within your trademark. If your mark contains descriptive words or common terms, you may need to disclaim exclusive rights to those elements while maintaining protection for the mark as a whole. This allows registration while acknowledging that certain parts are not exclusively yours.",
            },
            {
              question:
        ...
        },
        {
          ...
          questions: [
            {
              question:
                "Must I design a logo before I can register a trademark?",
              answer:
        ...
        },
        {
          ...
          questions: [
            {
              question:
                "Is a trademark registration valid for all goods and services?",
              answer:
                "No, trademark registration is limited to the specific goods and services listed in your application and classified according to the Nice Classification system. Your trademark protection only extends to the classes you've registered for. If you want to expand to other goods/services categories, you'll need to file additional applications for those specific classes.",
            },
            {
              question: "Is a Nigerian trademark recognized internationally?",
              answer:
                "No, Nigerian trademark registration only provides protection within Nigeria's borders. However, Nigeria is a member of the Madrid Protocol, which allows for international trademark registration through a single application. To protect your trademark in other countries, you can either file individual applications in each country or use the Madrid System for international registration.",
            },
            {
              question: "Can a trademark be sold or licensed?",
              answer:
                "Yes, trademarks are valuable business assets that can be sold (assigned) or licensed to other parties. Any assignment or licensing agreement must be recorded with the Trademark Registry to be legally effective. The new owner or licensee must meet the same requirements as the original applicant, and proper documentation must be filed with the registry.",
            },
          ],
        },
        {
          ...
          questions: [
            {
              ...
              answer:
                "A patent is an exclusive right granted by the government to an inventor for a new, useful, and non-obvious invention. In Nigeria, patents provide protection for inventions, giving the patent holder the exclusive right to make, use, sell, or import the patented invention for a specified period, typically 20 years from the filing date.",
            },
            {
              question: "Why register a patent?",
              answer:
                "Registering a patent provides legal protection for your invention, prevents others from making, using, or selling your invention without permission, allows you to license or sell your patent rights, enhances your business value and competitive advantage, and provides legal remedies against infringement.",
            },
            {
              question: "How long does a patent registration last?",
              answer:
                "In Nigeria, utility patents are valid for 20 years from the filing date, provided annual maintenance fees are paid. After expiry, the invention enters the public domain and can be freely used by anyone.",
            },
          ],
        },
        {
          ...
          questions: [
            {
              ...
              answer:
                "To register a patent in Nigeria: 1) Ensure your invention is new, useful, and non-obvious, 2) Conduct a patent search, 3) Prepare detailed patent application with specifications and claims, 4) File application with the Nigerian Patents and Designs Registry, 5) Pay required fees, 6) Undergo examination process, 7) Respond to office actions if any, 8) Patent granted if all requirements are met.",
            },
            {
              question: "How can I make payment?",
              answer:
                "Patent application fees in Nigeria can be paid through various methods including bank transfers, online payments through the registry portal, bank drafts payable to the Nigerian Patents and Designs Registry, or cash payments at designated registry offices. All payments should include proper reference numbers for tracking.",
            },
          ],
        },
      ],
      ...
      sections: [
        {
          ...
          questions: [
            ...
            },
            {
              ...
              answer:
                "Registering an industrial design provides exclusive rights to use, manufacture, and sell products with that design. It prevents others from copying your design's appearance, enhances commercial value, provides legal protection against infringement, and can be licensed or sold as a business asset.",
            },
          ],
        },
        {
          ...
          questions: [
            {
              ...
              answer:
                "To register an Industrial Design in Nigeria: 1) Ensure your design is new and has individual character, 2) Prepare clear representations of your design from multiple angles, 3) File application with the Nigerian Patents and Designs Registry, 4) Pay required fees, 5) Undergo examination, 6) Design registered if requirements are met. Protection lasts for 5 years and can be renewed.",
            },
            {
              question: "How can I make payment?",
              answer:
                "Industrial design application fees in Nigeria can be paid through various methods including bank transfers, online payments through the Nigerian Patents and Designs Registry portal, bank drafts payable to the registry, or cash payments at designated registry offices. All payments should include proper reference numbers for tracking.",
            },
          ],
        },
      ],
      ...
      sections: [
        {
          ...
          questions: [
            {
              question:
                "What are the general requirements for IP registration?",
              answer:
                "General requirements for intellectual property registration in Nigeria include: submitting proper application forms, paying prescribed fees, providing accurate representations or descriptions, meeting specific criteria for each IP type (novelty for patents, distinctiveness for trademarks, individual character for designs), and complying with formal requirements set by the respective registries.",
            },
            {
              question: "How long do IP registrations typically take?",
              answer:
                "IP registration timelines in Nigeria vary: Trademarks typically take 12-18 months, Patents take 2-4 years depending on complexity, and Industrial Designs usually take 6-12 months. Processing times may be longer if there are objections, oppositions, or if additional documentation is required.",
            },
            {
              question: "Can I check the status of my IP application?",
              answer:
                "Yes, you can check the status of your intellectual property applications through the respective registry portals online. The Nigerian Trademark Registry and Patents & Designs Registry provide online tracking systems where you can monitor your application progress using your application number and other reference details.",
            },
          ],
        },
      ],
  ...
  const getCurrentSectionIndex = (sectionId) => {
    return navigationTabs.findIndex((tab) => tab.id === sectionId);
  };

  // Helper function to get next and previous sections
  const getNextPrevSections = (currentSectionId) => {
    const currentIndex = getCurrentSectionIndex(currentSectionId);
    const prevSection =
      currentIndex > 0 ? navigationTabs[currentIndex - 1] : null;
    const nextSection =
      currentIndex < navigationTabs.length - 1
        ? navigationTabs[currentIndex + 1]
        : null;
    ...
    <main>
      ...
      <ScrollAnimation>
        <section className="mt-10 w-5/6 mx-auto text-center">
          <p className="text-3xl lg:text-5xl font-semibold">
            Frequently Asked{" "}
            <span className="text-green-700 block">Questions</span>
          </p>
          <p>
      ...
      <section className="w-5/6 mx-auto my-10">
        {faqData.map((section, sectionIndex) => {
          ...
          else if (section.category === "General Intellectual Property FAQs")
            sectionId = "general-faq";
          else if (
            section.category ===
            "COMMON MISTAKES BY ENTREPRENEURS AND SMALL BUSINESS OWNERS"
          )
            sectionId = "common-mistakes";

          const { prevSection, nextSection } = getNextPrevSections(sectionId);
              ...
              <div id={sectionId} className="mb-12 bg-gray-100 p-8 rounded-lg">
                ...
                <div className="mt-8 pt-6 border-t border-gray-300">
                  ...
                  <div className="flex items-center justify-between gap-4 mb-4">
                    ...
                    {prevSection ? (
                      <button
                        ...
                        className="px-4 py-2 bg-white border-2 border-gray-200 rounded-full shadow-sm hover:bg-green-50 hover:border-green-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-all duration-200 text-sm font-medium text-gray-700 hover:text-green-700 flex items-center gap-2"
                      >
                        <span>←</span>{" "}
                  ...
                  <div className="text-center">
                    ...
                    <NavigationTabs className="justify-center" />
                  </div>
                </div>
              </div>
            </ScrollAnimation>
